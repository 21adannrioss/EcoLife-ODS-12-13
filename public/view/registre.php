<?php include_once __DIR__ . '/../../includes/meta.php'; ?>
    ...
    <script src="<?= BASE_URL ?>/js/registre.js" defer></script>
...
<body>
    <main class="login-container">
        <section class="login-card">
            ...
            <form class="login-form" action="<?= BASE_URL ?>/controller/registre.proc.php" method="POST">
                <div class="grup-camp">
            ...
            <p class="login-footer">
                Ja tens compte?
                <a href="<?= BASE_URL ?>/public/view/login.php">Iniciar sessió</a>
            </p>
        </section>
